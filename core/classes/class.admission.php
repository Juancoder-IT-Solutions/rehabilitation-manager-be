...
class Admission extends Connection
{
    ...
    public function get_certificate(){
        ...
        $fetch = $this->select("tbl_certificates", "*", "tx_hash='$tx_hash' OR blockchain_hash='$tx_hash'");
    ...
    public function show()
    {
        ...
        $rows = array();
        $count = 1;
        $result = $this->select("$this->table a LEFT JOIN tbl_users u ON u.user_id=a.user_id LEFT JOIN tbl_certificates c ON a.admission_id=c.admission_id LEFT JOIN tbl_rehab_centers r ON a.rehab_center_id=r.rehab_center_id", 'a.*, u.user_fname, u.user_mname, u.user_lname, c.tx_hash, c.blockchain_hash, r.rehab_center_name, r.rehab_center_complete_address', "a.admission_id > 0 GROUP BY a.admission_id");
